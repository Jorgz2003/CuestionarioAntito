const quizData = [
  ...
  },
  {
    ...
    hint: "Piensa en la ley de Poiseuille (el radio es clave).",
    options: [
      ...
      { text: "El radio de las vías respiratorias", correct: true, feedback: "Pequeños cambios de diámetro alteran drásticamente la resistencia." },
  ...
  // IV. INTEGRACIÓN Y DETALLES ADICIONALES
  {
    ...
    hint: "Se produce por el cierre de las válvulas que conectan con la Aorta y Pulmonar.",
    options: [
      ...
      { text: "Tercer Ruido (R3)", correct: false, feedback: "Suele ser por llenado rápido ventricular, no marca el inicio de la diástole." },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Inhibe la producción de orina", correct: false, feedback: "Su efecto es vascular periférico." }
    ]
  },
  {
    category: "Integración y Detalles Adicionales",
